      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-24 text-center">
        ...
        <div className="mb-8 space-y-4">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold mb-2">
            Where <span className="text-yellow-400">Luck</span> Meets{" "}
            <span className="text-blue-400">Blockchain</span>
          </h2>

          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            The first truly decentralized lottery powered by{" "}
            <span className="text-blue-400 font-semibold">Chainlink VRF</span>
            <br />
            <span className="text-green-400 font-bold">
              Provably Fair • Instant Payouts • Global Access
            </span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-blue-400/50 transition-all duration-300 hover:bg-white/10 transform hover:-translate-y-2"
            >
        ...
        {/* Floating elements */}
        <div className="absolute top-20 left-10 text-6xl opacity-20 animate-bounce delay-500">
          💎
        </div>
        <div className="absolute bottom-20 right-10 text-4xl opacity-20 animate-pulse delay-700">
          🚀
        </div>
        <div className="absolute top-1/3 right-20 text-5xl opacity-20 animate-spin-slow">
          ⭐
        </div>
      </div>
