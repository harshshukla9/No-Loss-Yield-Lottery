...
dotenv.config();
const { lotteryContractAddress, abi, linkTokenAddress, linkTokenAbi, v2Abi, v2lotteryContractAddress } = require("./config");
...
const main = async () => {
    ...
    const approve = await linkToken.approve(v2lotteryContractAddress, ethers.parseEther("5"));
    await approve.wait();
